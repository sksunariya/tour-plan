...
function Tours( {tours, removeTour} ){
    ...
    return (
        <div className='font-poppins pb-4 flex flex-col gap-10 justify-center items-center'>
            <div className=''>
                <h1 className='tracking-wide text-center text-2xl lg:text-4xl font-semibold mt-10 px-10 py-4 border-[5px] border-blue-950 border-dashed rounded-xl'>Plan Your Tour</h1>
            </div>
